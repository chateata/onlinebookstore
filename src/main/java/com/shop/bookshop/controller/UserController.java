...
public class UserController {
  ...
  public ResultVO<java.math.BigDecimal> adjustBalance(
      @RequestParam Integer userId, @RequestParam java.math.BigDecimal delta) {
    ...
    java.math.BigDecimal cur =
        u.getAccountBalance() == null ? java.math.BigDecimal.ZERO : u.getAccountBalance();
